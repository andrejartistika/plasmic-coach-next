...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: E-h5s_FMDYaMRc/component
import Select__Option from "../../Select__Option"; // plasmic-import: cy0n3QtUybNPk/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_copy_of_coach_website.module.css"; // plasmic-import: oVWAucqWj6DsPJvsydPAdo/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: TB0rdnIYofo3d/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: nEbcHWzFYUKAen/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: L70RHZdo69Kf4u/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__nBYvo)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__bfkTz)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
