...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 6mZi2vo3eTrI4t/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: TB0rdnIYofo3d/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__lzovr)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__dFuCb)}
              />
            </React.Fragment>
          ),
          value: args.children
